...
/* harmony export */   uM: () => (/* binding */ institutionSchema),
...
const loginSchema = yup__WEBPACK_IMPORTED_MODULE_0__/* .object */ .Ry({
    username: yup__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Z_().email("Please enter a valid email address").required("Please provide the email"),
...
const forgotPwdSchema = yup__WEBPACK_IMPORTED_MODULE_0__/* .object */ .Ry({
    username: yup__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Z_().email("Please enter a valid email address").required("Please provide email address")
});
...
const institutionSchema = yup__WEBPACK_IMPORTED_MODULE_0__/* .object */ .Ry({
    institutionName: yup__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Z_().max(30, "You may only enter upto 30 characters").required("Please enter a University name"),
    adminFullName: yup__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Z_().max(30, "You may only enter upto 30 characters").required("Please enter admin full name"),
    adminDisplayName: yup__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Z_().max(30, "You may only enter upto 30 characters").required("Please enter a Password"),
    email: yup__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Z_().email().required("Please enter a email address").max(50, "You may only enter upto 50 characters"),
    crm: yup__WEBPACK_IMPORTED_MODULE_0__/* .string */ .Z_().max(30, "You may only enter upto 30 characters").required("Please enter a Password"),
    adminContact: yup__WEBPACK_IMPORTED_MODULE_0__/* .mixed */ .nK().required("Please enter a Phone number")
});
